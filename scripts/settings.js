...
function getEditCollectionHeader (collection, collections, theme) {
    ...
    url_element.innerHTML = `
        <div class="collection-info">
            ...
            <input class="input-color" type="color" value="${collection.color}" id="input-collection-color-edit-${collection.id}" title="Change collection color" />
...
function setCollectionActions (collection, collections, theme) {
    ...
    if (save_collection_button) {
        save_collection_button.addEventListener("click", (event) => {
            ...
            collection.color = document.getElementById(`input-collection-color-edit-${collection.id}`).value;
